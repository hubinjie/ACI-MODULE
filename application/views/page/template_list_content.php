{php $attache_css[] = SKIN_PATH."article.css"; }
...
<div class="article">
    <div class="container ">
        ...
        <ul class="breadcrumb">
            ...
            <?php if($parent_menu_info):?><li><a href="{$parent_menu_info['menu_url']}">{$parent_menu_info['menu_name']}</a></li><?php endif;?>
            <li class="active"><a href="{$cat_info['menu_url']}"><?php echo $cat_info['menu_name']?></a></li>
        </ul>
