...
final class Template_cache {
	 ...
	 * @return ture
	 */
	public function template_parse($str,$include_php_defined = true) {
		...
		if($include_php_defined)$str = "<?php defined('BASEPATH') or exit('No direct script access allowed.'); ?>" . $str;
		return $str;
	}
